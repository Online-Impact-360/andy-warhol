...
const baseField =
  "h-12 px-4 bg-transparent border border-line rounded-none focus:border-gold outline-none text-warm-white text-[16px] placeholder-warm-white/40 w-full transition-colors";
const baseLabel = "font-inter text-[14px] text-white/80";
